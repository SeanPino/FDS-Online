...
class API {
    ...
    public function initEndpoints() {
         ...
         */
        $this->app->get('/api/v1/jobs/:id', function ($id)
        {
        	DB::FindJob($id, $this->app);
        });
         ...
         * @apiSuccess (200 OK) {String} status Status of the current job.
         */
        $this->app->get('/api/v1/stop/:id', function ($id)
        {
        	DB::StopJob($id, $this->app);
        });
         ...
         * @apiSuccess (200 OK) {String} status Status of the current job.
         */
        $this->app->get('/api/v1/start/:id', function ($id)
        {
        	DB::StartJob($id, $this->app);
        });
        ...
        $this->app->get('/api/v1/list/', function ()
        {

        	// Grab the list of files.
        	//$db->ListJobs();
        	DB::ListJobs($this->app);
         ...
         */
        $this->app->delete('/api/v1/delete/:id', function ($id)
        {
        	return DB::DeleteJob($id, $this->app);
        });
         ...
         */
        $this->app->get('/api/v1/download/:id', function($id)
        {
        	$job = DB::GetJob($id);
         ...
         * @apiSuccess (200 OK) {String} filename The name of the uploaded file.
         */
        $this->app->post('/api/v1/jobs/', function ()
        {
         ...
         */
        $this->app->get('/api/v1/wipe/', function()
        {
            R::wipe("job");
